...
/// Replace these with the real catalog before production.
const maisonDemoProducts = <MaisonProduct>[
  MaisonProduct(
    id: 'mat-001',
    name: 'زيت الخزامى',
    nameFr: 'Huile de Lavande',
    nameEn: 'Lavender Oil',
    ...
    stock: 20,
    minStock: 3,
    description: 'زيت الخزامى 30ml',
    createdAt: DateTime(2026, 1, 1),
  ),
  MaisonProduct(
    id: 'mat-002',
    name: 'زيت الليمون',
    nameFr: 'Huile de Citron',
    nameEn: 'Lemon Oil',
    category: ProductCategory.oils,
    gender: ProductGender.unisex,
    size: '30 ml',
  ...
  MaisonProduct(
    id: 'mat-004',
    name: 'خمرة دخان',
    nameFr: 'Khamrah Dokhan',
    nameEn: 'Khamrah Dokhan',
    category: ProductCategory.perfumes,
    gender: ProductGender.unisex,
    size: '100 ml',
    sku: 'PER-KHD-100',
