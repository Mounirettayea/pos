import 'package:maison_al_teeb_pos/core/widgets/primary_button.dart';
                                    ...
                                    ...billingState.cartItems.map((item) {
                                      return TableRow(
                                        children: [
                                          ...
                                          _buildDataCell(
                                              'DH${item.product.price.toStringAsFixed(2)}',
                                              TextAlign.right,
                                              isSubtitle: true),
                                          _buildDataCell(
                                              'DH${item.total.toStringAsFixed(2)}',
                                              TextAlign.right,
                                              isBold: true),
                                        ],
                                      );
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'DH${billingState.totalAmount.toStringAsFixed(2)}',
